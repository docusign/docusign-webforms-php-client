...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://www.docusign.net/webforms/v1.1';
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/1.1.0/1.0.2-rc11/php/' . PHP_VERSION;
    ...
    {
        $report  = 'PHP SDK (DocuSign\WebForms) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.1.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.2-rc11' . PHP_EOL;
