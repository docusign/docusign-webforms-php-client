...
class HttpError implements ModelInterface, ArrayAccess
{
     ...
     * Sets error_code
     *
     * @param ?string $error_code A granular, human and computer readable code indicating more deeply what error occurred.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param ?string $message A human-readable description of the error, meant for developers to store for their review.
     *
     * @return $this
     */
