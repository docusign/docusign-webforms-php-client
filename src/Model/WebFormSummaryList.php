...
/**
 * WebFormSummaryList Class Doc Comment
 *
 * @category    Class
...
class WebFormSummaryList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebFormSummaryList';
     ...
     * Sets items
     *
     * @param \DocuSign\WebForms\Model\WebFormSummary[] $items Array of web form items with each containing summary.
     *
     * @return $this
     */
     ...
     *
     * @param float $result_set_size Result set size for current page
     *
     * @return $this
     */
     ...
     * Sets total_set_size
     *
     * @param float $total_set_size Total result set size
     *
     * @return $this
     */
     ...
     * Sets start_position
     *
     * @param float $start_position Starting position of fields returned for the current page
     *
     * @return $this
     */
     ...
     * Sets end_position
     *
     * @param float $end_position Ending position of fields returned for the current page
     *
     * @return $this
     */
