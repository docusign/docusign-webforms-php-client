...
/**
 * UpdateInstanceRequestBody Class Doc Comment
 *
 * @category    Class
 * @description Request body containing properties that needs to be updated.
 * @package     DocuSign\WebForms
 * @author      Swagger Codegen team <apihelp@docusign.com>
 * @license     The DocuSign PHP Client SDK is licensed under the MIT License.
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateInstanceRequestBody';
